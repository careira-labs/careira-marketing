...
// Popular countries pinned first, then full alphabetical list

const POPULAR_COUNTRIES: SelectOption[] = [
...
const popularCodes = new Set(POPULAR_COUNTRIES.map((c) => c.value));

export const COUNTRIES: SelectOption[] = [
  ...POPULAR_COUNTRIES,
  ...ALL_COUNTRIES.filter((c) => !popularCodes.has(c.value)),
];
...
export const CANDIDATE_INTENTS: SelectOption[] = [
  { value: 'Finding a new role', label: 'Finding a new role' },
  { value: 'Exploring what\'s out there', label: 'Exploring what\'s out there' },
  { value: 'Career development', label: 'Career development' },
  { value: 'Returning to work', label: 'Returning to work' },
];

export const RECRUITER_INTENTS: SelectOption[] = [
  { value: 'Hiring for open roles', label: 'Hiring for open roles' },
